...
class CameraController:
    ...
    def generate_scene_and_images(self, robot_one, robot_two, num_images_tw):
        ...
        self.generate_n_images(num_images_tw, f"cam_red_{self.current_red_robot}_{self.current_blue_robot}_ball_not_in_image_far", False, True)
        ...
        self.generate_n_images(num_images_tw, f"cam_blue_{self.current_red_robot}_{self.current_blue_robot}_ball_not_in_image_far", False, True)
            ...
            for a in current_annotation:
                if a["type"] in robot_equivalent and a["in_image"]:
                    ...
                    new_annotations.append({"type": "robot", "in_image": True, "pose": pose_dict, "vector": vector,
                                            ...
                                            "color": "red" if "RED" in a["type"] else "blue",
                                            "model": self.robots[self.current_red_robot if "RED" in a["type"] else self.current_blue_robot]["proto"]})
                    found_robot = True
